sap.ui.define([
    ...
    function (Controller,Fragment,MessageToast) {
        ...
        return Controller.extend("com.smod.todoappnew.controller.View1", {
            onInit: function () {
            ...
            onItemButtonPressed: function (event) {
                ...
                if (!this._oActionSheet) {
                  this._oActionSheet = Fragment.load({
                    id: oView.getId(),
                    name: "com.smod.todoappnew.fragment.TodoActions",
                    controller: this,
                  }).then(
            ...
            onUndoItem: function(event){
              //var  oViewModel = this.getView().getModel("todoModel");
              //var  oItem = oViewModel.getProperty("/CurrentTodo");
              //oItem.IsCompleted = false;
              //oViewModel.setProperty("/CurrentTodo",oItem);
              var oButton = event.getSource();
              var oActionSheet = oButton.getParent();
