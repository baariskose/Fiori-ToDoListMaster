		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "To Do List",
									"targetURL": "#comsmodtodoappnew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodtodoappnew-display": {
								"semanticObject": "comsmodtodoappnew",
								"action": "display",
								"description": "To Do List Master",
								"title": "To Do List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.todoappnew",
									"url": sap.ui.require.toUrl("com/smod/todoappnew")
								}
							}
						}
					}
